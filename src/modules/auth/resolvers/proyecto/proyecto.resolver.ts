...
export class ProyectoResolver {
    ...
    constructor(@Inject(ProyectoService) private proyectoService: ProyectoService) { }
    ...
    @Mutation(() => Proyecto)
    updateProyecto(@Args('updateProyectoInput') updateProyectoInput: UniqueProyecto) {
        return this.proyectoService.update({ where: { id: updateProyectoInput.id }, data: updateProyectoInput });
    }
